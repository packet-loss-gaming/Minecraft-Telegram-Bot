...
public class OutboundSilentTextMessageEvent extends ProtocolEvent {
    private final String text;

    public OutboundSilentTextMessageEvent(String text) {
        this.text = text;
    }
    ...
    public EventType getType() {
        return EventType.OUTBOUND_SILENT_TEXT_MESSAGE;
    }
}
