...
public class InboundNewMessageEvent extends InboundTextMessageEvent {
    public InboundNewMessageEvent(TextMessage message) {
        super(message);
    }

    @Override
    public EventType getType() {
        return EventType.INBOUND_NEW_MESSAGE;
    }
}
