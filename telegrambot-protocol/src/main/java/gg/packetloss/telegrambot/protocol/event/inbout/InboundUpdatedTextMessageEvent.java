...
public class InboundUpdatedTextMessageEvent extends InboundTextMessageEvent {
    public InboundUpdatedTextMessageEvent(TextMessage message) {
        super(message);
    }

    @Override
    public EventType getType() {
        return EventType.INBOUND_UPDATED_MESSAGE;
    }
}
